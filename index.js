...
Portfolio.component('icon-link',{
    data(){
        return{
            link:{
                github:"https://github.com/nabeman",
                twitter:"https://twitter.com/takumicoins20"
            },
            svg:{
    ...
    computed:{
        title_data(){
            this.icon_name = this.title
        }
    },
    props:['title'],
    template:`
    <a :href="giveLink(this.icon_name)" :class="title" v-html="giveSVG(this.icon_name)"></a>
    `
})
